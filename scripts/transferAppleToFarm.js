...
module.exports = async function (callback) {
  ...
  const myToken = await Apple.deployed()
  ...
  await myToken.approve(farmToken.address, web3.utils.toWei("0.001", "ether"))
  ...
  await farmToken.deposit(web3.utils.toWei("0.001", "ether"))
